              ...
              return (
                <article key={l.id} className="listing-card">
                  <div className="listing-card-head">
                    <h4>{l.title || l.address || 'Untitled listing'}</h4>
                    {supportOn ? (
                      <span className="demo-badge demo-badge-direct">support on</span>
                    ) : (
                      <span className="demo-badge demo-badge-mock">support off</span>
                    )}
                  </div>
                  <p className="listing-card-meta">
                    ...
                    {l.nightlyPrice && <span> · ${l.nightlyPrice}/night</span>}
                  </p>
                  <div className="listing-card-actions">
                    {supportOn ? (
                      <span className="callmodal-hint">AI customer support is active for this listing.</span>
                    ) : (
                      <button
